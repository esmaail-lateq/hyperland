    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between h-20 lg:h-24">
            ...
            <nav class="hidden sm:flex items-center space-x-2 lg:space-x-3">
                ...
                <!-- Dealers Link -->
                <a href="{{ route('dealers.index') }}" class="group relative px-4 py-3 rounded-full transition-all duration-300 hover:bg-white/20 dark:hover:bg-slate-800/20 hover:scale-105 backdrop-blur-sm border border-transparent hover:border-white/20 dark:hover:border-slate-600/20 {{ request()->routeIs('dealers.index') ? 'bg-white/30 dark:bg-slate-800/30 shadow-lg' : '' }}">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-base lg:text-lg font-medium text-slate-700 dark:text-slate-200 group-hover:text-slate-900 dark:group-hover:text-white transition-colors duration-300">{{ __('navigation.dealers') }}</span>
                    </div>
